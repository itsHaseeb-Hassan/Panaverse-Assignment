...
// List of usernames
const current_users: string[] = ["Alice", "Bob", "John", "Sarah", "Eva"];

// List of new usernames
const new_users: string[] = ["John", "Eric", "Mia", "Chris", "ALICE"];

for (let i=0;i<new_users.length;i++) {
  // Convert to lowercase for comparison
  const lowercase_new_username: string = new_users[i].toLowerCase();
